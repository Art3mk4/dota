			...
			<div class="row text-center">
				<div class="col-sm-6">
					...
					<div class="col-sm-6 col-xs-6">
						...
						<div class="fire-text">annual income of some StarCraft players</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="col-sm-6 col-xs-6">
					...
					<div class="col-sm-6 col-xs-6">
						...
						<div class="fire-text">rating of eSports betting by 2018 (even football bets left behind)</div>
					</div>
				</div>
			</div>
			<div class="row">
